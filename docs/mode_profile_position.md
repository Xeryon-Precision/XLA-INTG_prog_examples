...
This README provides a detailed explanation for profile position mode using CiA 402-compliant devices from Xeryon over CANopen. It outlines when and where to apply configuration, how to transition through the state machine, and how to interact with standard CiA 402 objects like Controlword (0x6040), Statusword (0x6041), and Target Position (0x607A).
